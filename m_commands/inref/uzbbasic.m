uzbbasic;
	...
	. zbreak zbbasic+lineno^zbbasicexec:"set uzbbasic("""_$C(lineno+255)_lineno_""")=$get(uzbbasic("""_$C(lineno+255)_lineno_"""))+1"
	write "After break points set: Show the break points and stack:"  zshow "BS"
	;
	write "Test xecute",!
	for lineno=begline:1:maxline  do
	. xecute "set uzbbasic("""_$C(lineno+255)_lineno_""")=$get(uzbbasic("""_$C(lineno+255)_lineno_"""))+1"
	write "Verify xecute",!
	for lineno=begline:1:maxline  do
	. if uzbbasic(""_$C(lineno+255)_lineno_"")'=step write "Test Failed in xecute",! zwr uzbbasic
	;
	set step=2
	...
	for lineno=begline:1:maxline  do
	. if uzbbasic(""_$C(lineno+255)_lineno_"")'=step write "Test Failed in zbreak action",! zwr uzbbasic
	;
	set step=3
	write "Set break points again",!
	for lineno=begline:1:maxline  do
	. set cmd(lineno)="set uzbbasic("""_$C(lineno+255)_lineno_""")=$get(uzbbasic("""_$C(lineno+255)_lineno_"""))+1"
	...
	;
	;
	write "zlink ""zbbasicexec""",!   zlink "zbbasicexec"
	write "After zlink zbbasiecexec : Show the break points and stack:"  zshow "BS"
	;

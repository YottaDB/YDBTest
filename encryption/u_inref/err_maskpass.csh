...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "$gtm_test/big_files/dbload/tape5.dat" # 29K file
echo "SOMEPASSWORD" | $save_gtm_dist/plugin/gtmcrypt/maskpass
# Note: with gtm_obfuscation_key if the password is the same and the contents of the file is the same the obfuscated
# key will be the same so put it in the output stream.
$echoline
...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "$gtm_test/big_files/dbload/tape1.dat" #1M file
echo "SOMEPASSWORD" | $save_gtm_dist/plugin/gtmcrypt/maskpass
# Note: with gtm_obfuscation_key if the password is the same and the contents of the file is the same the obfuscated
# key will be the same so put it in the output stream.
$echoline
...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "My kingdom for a horse!"
...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "nonexistant.txt"
...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "unreadable.txt"
...
source $gtm_tst/com/set_ydb_env_var_random.csh ydb_obfuscation_key gtm_obfuscation_key "$PWD"

	...
	. if rectype'=EOT do
	.. if rectype'=TSTART set filtrOut=TSTART_EOL_NULL_EOL_TCOMMIT_EOL
	.. else  do
	... set filtrOut=extrRec_EOL
	... for  read extrRec set filtrOut=filtrOut_NULL_EOL quit:$ze(extrRec,1,2)=TCOMMIT
	... if $zeof halt

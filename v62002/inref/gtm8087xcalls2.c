...
void MurmurHash3_x86_128 ( const void * key, const int len, uint4 seed, void * out )
{
	int i;
...
void MurmurHash3_x64_128 ( const void * key, const int len, const uint4 seed, void * out )
{
	int i;
	const unsigned char * data = (const unsigned char*)key;
	const unsigned char * tail;
...
#define UNALIGNED_SAFE	(defined(__i386) || defined(__x86_64__))

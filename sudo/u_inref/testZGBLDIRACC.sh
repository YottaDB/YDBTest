...
#################################################################
#
# Routine to cause a ZGBLDIRACC error to be raised which usually logs to the syslog unless the userid's group is listed
...
# Drive YDB trying to set a node force the ZGBLDIRACC error which normally automatically gets logged to syslog

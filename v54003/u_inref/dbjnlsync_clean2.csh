...
#
# cleanterm2:  Clean database termination but (jfh->eov_tn > db->curr_tn)	
...
# take copy of mumps.mjl to mumps.mjl_bkup respectively
...
#restore mumps.mjl_bkup to mumps.mjl which will cause jfh->eov_tn > db->curr_tn
cp mumps.mjl_bkup mumps.mjl

...
gtm8015	;test unsupported values for gtm_boolean and gtm_side_effects are suppressed
	if '$data(act) new act set act="if $increment(cnt) use $principal write !,$zstatus zshow ""v"""
	...
	view "nofull_boolean"
	set expect=""
	if fb,'se xecute "set a=2,b=3,ex=0,x=0&$$times(a,b)" if ex xecute act

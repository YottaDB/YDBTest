...
# Turn off encryption for this test as otherwise dbcreate.csh -> dbcreate_base.csh -> create_key_file.csh will
# eventually call "mumps -run CONVDBKEYS" which would fail assert due to the above special collation routine setup.

...
$grep -E "YDB-E|No errors" integr.out1
mipcmanage
$MUPIP integ -reg "*" >& integr.out2
$grep -E "YDB-E|No errors" integr.out2
mipcmanage

echo "***** b.dat R/O *****"
chmod 444 b.dat
$MUPIP integ -FAST -reg "*" >& integr.out3
$grep -E "YDB-E|No errors" integr.out3
mipcmanage
$MUPIP integ -reg "*" >& integr.out4
$grep -E "YDB-E|No errors" integr.out4
mipcmanage
\rm -f *.dat
...
$grep -E "YDB-E|No errors" integr.out5
mipcmanage
$MUPIP integ -reg "*" >& integr.out6
$grep -E "YDB-E|No errors" integr.out6
mipcmanage
...
$grep -E "YDB-E|No errors" integr.out7
mipcmanage
$MUPIP integ -reg "*" >& integr.out8
$grep -E "YDB-E|No errors" integr.out8
mipcmanage
...
$grep -E "YDB-E|No errors" integr.out9
mipcmanage
$MUPIP integ -reg "*" >& integr.out10
$grep -E "YDB-E|No errors" integr.out10
mipcmanage
...
$grep -E "YDB-E|No errors" integr.out11
mipcmanage
$MUPIP integ -reg "*" >& integr.out12
$grep -E "YDB-E|No errors" integr.out12
mipcmanage
chmod 666 *.dat *.mjl

...
# CASE 1
echo "# case 1 setup : merge source : mumps.gld : ^a    spans areg and breg"
echo "#                merge target : other.gld : ^a(1) spans breg and creg"
setenv gtmgbldir mumps.gld
...
$gtm_tst/com/backup_dbjnl.csh "merge_desc_case1" "*.gld *.dat *_gld.out" mv


# CASE 2
echo "# case 2 setup : merge source : mumps.gld : ^a    spans areg    and breg"
echo "#                merge target : other.gld : ^a(1) spans default and creg"
...
echo "# merge ^|other.gld|a(1)=^a should work as src(^a) spans areg and breg ; but dest(^a(1)) spans default and creg"
$GTM << GTM_EOF
	merge ^|"other.gld"|a(1)=^a
GTM_EOF
$gtm_exe/mumps -run %XCMD 'set $zgbldir="other.gld" zwrite ^a'

$gtm_tst/com/backup_dbjnl.csh "merge_desc_case2" "*.gld *.dat *_gld.out" mv


# CASE 3
echo "# case 3 setup : merge source : mumps.gld : ^a spans areg and breg"
echo "#                merge target : other.gld : ^a(1) maps to breg and does not span regions"
...
$gtm_tst/com/backup_dbjnl.csh "merge_desc_case3" "*.gld *.dat *_gld.out" mv


# CASE 4
echo "# case 4 setup : merge source : other.gld : ^a(2) maps to areg - no spanning"
echo "#                merge target : mumps.gld : ^a spans areg and breg"
...
$gtm_tst/com/backup_dbjnl.csh "merge_desc_case4" "*.gld *.dat *_gld.out" mv

# CASE 5
echo "# case 5 setup : merge source : other.gld : ^a(2) maps to areg - no spanning"
echo "#                merge target : mumps.gld : ^a spans areg breg creg and default"
...
$gtm_tst/com/backup_dbjnl.csh "merge_desc_case5" "*.gld *.dat *_gld.out" mv

# CASE 6
echo "# case 6 setup : merge source : other.gld : ^a maps to areg - no spanning"
echo "#                merge target : mumps.gld : ^a(2) spans areg breg creg and default"
...
$gtm_tst/com/backup_dbjnl.csh "merge_desc_case6" "*.gld *.dat *_gld.out" mv

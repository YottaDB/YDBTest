...
# start up the first level of secondaries
$MSR START INST1 INST2 RP
get_msrtime ; set time_msr_list = ($time_msr_list $time_msr)
$MSR START INST1 INST3 RP
get_msrtime ; set time_msr_list = ($time_msr_list $time_msr)

# start the second level of propagating instances
$MSR START INST2 INST4 PP
get_msrtime ; set time_msr_list = ($time_msr_list $time_msr)
$MSR START INST2 INST5 PP
get_msrtime ; set time_msr_list = ($time_msr_list $time_msr)

set instlist = (INST1 INST2 INST3 INST4 INST5)
set srclist  = (INST1 INST2 INST3            )
set rcvlist  = (      INST2 INST3 INST4 INST5)

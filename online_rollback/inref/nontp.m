...
test2	; Should issue a DBROLLEDBACK error because online rollback increments cycles on non-journaled regions on the current
	; instance as well.
	new $etrap
	set $etrap="do err^nontp"
	set ^hnonjnld=1
...
test5	; This is test4 done in the reverse direction
	...
	set ^|"mumps2.gld"|b=1	; Should issue a DBROLLEDBACK error
	quit

...
public class TestCI {
	...
	public static void getTest11() throws Exception {
		...
		final String[] javaResponses = new String[]{
			"150379666,%GTM-E-CINOENTRY, No entry specified for abc123 in the call-in table\n",
	...
	public static void getTest13() throws Exception {
		...
		TestCase[] testCases = new TestCase[] {
			new TestCase("Test13", TestCase.CALL_IN, GTMType.VOID, formals) {
				...
				@Override
				public String getJavaResponse() {
					return "150374474,%GTM-E-ACTLSTTOOLONG, More actual parameters than formal parameters: lbl0\n";
				}
			}
		};
	...
	public static void getTest23() throws Exception {
		...
		for (int codeCase = 0; codeCase < numOfCases; codeCase++) {
			...
			testCases[codeIndex] = new TestCase("Test23", TestCase.CALL_IN, GTMType.VOID) {
				...
				public String getJavaResponse() {
					if (codeIndex == 0)
						return "150373978,%GTM-E-ZLINKFILE, Error while zlinking \"abc\",%GTM-E-FILENOTFND, File abc not found\n";
					else
						return "150373122,%GTM-E-JOBLABOFF, Label and offset not found in created process\n";
				}

...
lvnget1
	...
	write "lvnget1: Variables generated - ZSHOWing them to internal array",!
	zshow "v":%lvvardump
	;
	...
	;
	set %outfn="lvnget1-M-extract.txt"
	write "lvnget1: Variables generated - writing out to ",%outfn,!
	open %outfn:new
	use %outfn
	for %indx=1:1 set %line=$get(%lvvardump("V",%indx),"") quit:(""=%line)  write %line,!
	close %outfn
	write "lvnget1: Variables written - driving external call for call-backs via tp_get_s() in the simpleAPI",!
	;

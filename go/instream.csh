...
# Note : there used to be a check here that excluded the "fatal_signal" subtest if YottaDB was built with
# ASAN + CLANG + DEBUG. It was removed since "com/gtmtest.csh" now excludes this entire test directory
# whenever the build has ASAN, which makes any ASAN check inside this script unreachable.

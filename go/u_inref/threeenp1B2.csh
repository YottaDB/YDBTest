...
$gobuild  $gtm_tst/$tst/inref/threeenp1B2.go >& go_build.log || \
	echo "TEST-E-FAILED : Unable to build threeenp1B2.go. go_build.log output follows." && cat go_build.log && exit 1
#

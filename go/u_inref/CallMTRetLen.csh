...
$gobuild $gtm_tst/$tst/inref/CallMTRetLen.go >& go_build.log || \
	echo "TEST-E-FAILED : Build of test failed" && cat go_build.log && exit 1
...
echo
echo "# Running Go program"
$gobuild $gtm_tst/$tst/inref/CallMParmTesting.go >& go_build.log || \
	echo "TEST-E-FAILED : Build of test failed" && cat go_build.log && exit 1

...
#
setenv timefile  "time_onlnbkup_rcvr.log"
echo "Buffer Size is $tst_buffsize bytes" >>&! $tst_general_dir/$timefile
#
$sec_shell "$sec_getenv; cd $SEC_SIDE; mkdir -p $test_remote_bakdir"
#
...
$gtm_tst/com/rfstatus.csh "After_receiver_restart:"
sleep $test_backlog_time
#
$gtm_tst/com/rfstatus.csh "Before_Online_BKUP:"
echo "Starting online backup on secondary side..."
$sec_shell "$sec_getenv; cd $SEC_SIDE; $gtm_tst/$tst/u_inref/online_bak_bkgrnd.csh $test_remote_bakdir $SEC_SIDE/$timefile "">>&!"" online.out"
sleep $test_backlog_time
#
...
egrep "%GTM-E"  $tst_general_dir/online.out*
egrep "%GTM-F"  $tst_general_dir/online.out*

...
foreach chset("UTF-8" "M")
	...
	foreach ext("zwr" "bin" "go")
		if (("M" == $chset) && ("go" == $ext)) then
			...
			$gtm_tst/$tst/u_inref/testloadcheck.csh "$file.$ext" "-ignorechset"
		endif
	end
end
...
foreach option("-i" "-ig" "-ign" "-igno" "-ignor" "-ignore" "-ignorec" "-ignorech" "-ignorechs" "-ignorechse")
        $gtm_tst/$tst/u_inref/testloadcheck.csh "extr3.zwr" $option
end
...
echo "=========================================="
$gtm_tst/$tst/u_inref/testloadcheck.csh "extr3.zwr" ""

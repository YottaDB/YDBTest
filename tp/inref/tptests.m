TPTESTS	; ; ; create index blocks, destroy them and recreate them in a transaction
	;
	n (act)
	...
	v "gdscert":1
	tstart ():serial
	f i=1:1:7 s ^a(i_$j(i,150))=$j(i,240)
	f i=1:1:6 k ^a(i_$j(i,150))
	f i=6:-1:1,8 s ^a(i_$j(i,150))=$j(i,240)
	tcommit
	d test(8)

tptestf	; ; ; test various tp operations
	;
...
garbage(%max,%kil)
	...
	. . f %ln=1:1:($$random(7)+1) s %lnam=%lnam_$e(%str,$$random(52)+1) 
   	. . f %ln=1:1:($$random(%maxkey*.5+1)+1) s %sub1=%sub1_$e(%str,$$random(52)+1)
	. . f %ln=1:1:($$random(%maxkey*.5+1)+1) s %sub2=%sub2_$e(%str,$$random(52)+1)

tptest7 ; ; ; test after effecs of tp rollback
	;
	...
	. i play<1 s setaprx=150,kilaprx=0,maxkey=54;$$random(151),kilaprx=$$random(1),maxkey=$$random(35)+20
	...
	.. s strt="^%"
	.. k @strt
	.. f  s glb=$o(@strt) q:glb=""  w !,glb k @glb
	.. d test(0)
	.. tcommit
	.. w !!,"tcommit"
	.. d test(0)

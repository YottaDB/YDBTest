...
echo "# ---------------------------------------------------------------------------"
echo "# Run [mumps -run ydb1091lt] to generate [boolexpr.m] with various simple boolean expressions"
$gtm_dist/mumps -run ydb1091lt > boolexpr.m
...
if (! $perf_missing && ! $gtm_test_libyottadb_asan_enabled && ("pro" == "$tst_image") && ("x86_64" == `uname -m`)	\
	...
	set limit = (3028303698 3028303832 3088307546 3038307601)

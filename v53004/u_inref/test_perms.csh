...
set file_awk_cmd = "$file_awk_cmd"' $0 ~ /%GTM-E-OBJFILERR/					{ gsub(/%GTM-E-OBJFILERR.*/, "") }'
set file_awk_cmd = "$file_awk_cmd"' $0 ~ /%GTM-E-ZLNOOBJECT/					{ gsub(/%GTM-E-ZLNOOBJECT, /, "") }'
set file_awk_cmd = "$file_awk_cmd"' $0 ~ /mumps.(mjl|dat)|'$objdir'|gtm-relinkctl/		{ print $1 "," user "," group }'
set file_awk_cmd = "$file_awk_cmd"' $0 !~ /mumps.(mjl|dat)|'$objdir'|gtm-relinkctl/'

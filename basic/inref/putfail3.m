; GVPUTFAIL regression test	3/9/93
;
; Requirements:
...
; This line used to cause a GVPUTFAIL, failure code HHHH
	Set ^PF("A45")="X45"_X1000_X300_X300

	Set PASS=1
	For i=10:10:60 If ^PF("A"_i)'=("X"_i_X300) Set PASS=0 Write "^PF(""A"_i_""") not stored properly",!
	If ^PF("A45")'=("X45"_X1000_X300_X300) Set PASS=0 Write "^PF(""A45"") not stored properly",!
	If PASS Write "   PASS - putfail3",!
	Else  Write "** FAIL - putfail3",!  Set errcnt=errcnt+1
	Quit

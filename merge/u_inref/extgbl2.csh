...
if ( "GT.CM" == "$test_gtm_gtcm") setenv gtcm_save "GT.CM"
...
setenv gtm_test_sprgde_id "ID1"	# to indicate the following dbcheck corresponds to the ID1 dbcreate
$gtm_tst/com/dbcheck.csh -extr
setenv test_gtm_gtcm "GT.M"
unsetenv test_replic
setenv gtm_test_sprgde_id "ID2"	# to indicate the following dbcheck corresponds to the ID2 dbcreate
$gtm_tst/com/dbcheck.csh mumps -nosprgde

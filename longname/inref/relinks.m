...
relinks;
	...
	;
	write "Following will error out while it tries to link itself",!
	write "zlink ""relinks""",! do:unix copy zlink "relinks"
	quit
enable(fn)
	write "enable:",fn,!
	k zstr
	...
	. zsystem "delete /nolog lnkrtn.obj;*"
	. set cp="copy /nolog "
	set zstr="zsystem """_cp_fn_".m lnkrtn.m"""
	xecute zstr
	zlink "lnkrtn"
	if cnt=1 do
	. for lineno=begline:1:maxline  do
...
copy
	new i,file,line
	set file="relinks.o"
	zsystem "cp relinks.o relinks.o.bak; cp relinks.m relinks.m.bak"
	open file
	close file:delete
	set file="relinks.m"
	open file:newversion
	use file
	for i=0:1 set line=$text(relinks+i^relinks) quit:("END"=line)  write line,!
	close file
	quit

...
set diff_file="straight_nct_$tstamp.diff"
diff $gtm_tst/$tst/inref/straight_nct.txt straight_nct.out >& "$diff_file"
if $status then
	echo "Globals collation check FAILED"
	echo "Check straight_nct_$tstamp.diff"
else

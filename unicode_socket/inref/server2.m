...
server	s portno=^configasalongvariablename78901("portno"),delim=^configasalongvariablename78901("delim")
	...
	o tcpdevasalongvariablename678901:(ochset="UTF-8":ZLISTEN=portno_":TCP":attach="server":delimiter=delim):timeout:"SOCKET"
	i  d
	...
	w "ওরা েকন বাংলা বলেত পাের না ?",delim,"அவர்கள் ஏன் தமிழில் பேசக்கூடாது ?",!
	if (rdcnt=4) d ^waitforread("last",30)

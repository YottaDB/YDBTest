...
youtputs: void outputs_tester(O:ydb_int_t*, O:ydb_uint_t*, O:ydb_long_t*, O:ydb_ulong_t*, O:ydb_int64_t*, O:ydb_uint64_t*, O:ydb_float_t*, O:ydb_double_t*, O:ydb_char_t*[100], O:ydb_string_t*[100], O:ydb_buffer_t*[100], O:ydb_char_t**)
...
coutputs: void outputs_tester(O:int*, O:uint*, O:long*, O:ulong*, O:int64*, O:uint64*, O:float*, O:double*, O:char*[100], O:string*[100], O:ydb_buffer_t*[100], O:char**)

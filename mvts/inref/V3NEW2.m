V3NEW2 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"72---V3NEW2: NEW -2-"
 ;
3 S ^ABSN="30910",^ITEM="III-0910  $D(lvn)=10"
 S ^NEXT="4^V3NEW2,V3NEW3^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 S ^VCORR="000/11 1 1 0 10 1 0 0 aa(2)bc(2)#10 1 10 1 10 1 0 0 A(2)B(2)C(2)"
 D ^VEXAMINE
 ;
4 S ^ABSN="30911",^ITEM="III-0911  $D(lvn)=11"
 S ^NEXT="^V3NEW3,V3NEW3^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""

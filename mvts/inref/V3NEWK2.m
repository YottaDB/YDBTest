V3NEWK2 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"90---V3NEWK2: NEW -20-"
 ;KILL command
 ;
39 S ^ABSN="30946",^ITEM="III-0946  $D(lvn)=10"
 S ^NEXT="40^V3NEWK2,V3NEWK3^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 S ^VCORR="10100/11 1 11 1 10 1 0 0 aa(2)bB(2)c(2)#1 0 11 1 10 1 0 0 abB(2)c(2)#1 0 11 1 10 1 0 0 abB(2)C(2)"
 D ^VEXAMINE
 ;
40 S ^ABSN="30947",^ITEM="III-0947  $D(lvn)=11"
 S ^NEXT="^V3NEWK3,V3NEWK4^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="01111/11 1 11 1 11 1 0 0 aa(2)bB(2)Cc(2)#1 0 11 1 11 1 0 0 abB(2)Cc(2)#11 1 11 1 11 1 0 0 AA(2)bB(2)Cc(2)"
 D ^VEXAMINE
 ;
END W !!,"End of 90 --- V3NEWK2",!
 K  Q
 ;
NEWSEL3 ;
 NEW C
...
NEWSEL4 ;
 ...
 S ^VCOMP=^VCOMP_"#"                      ;#
 K A(2)
 S ^VCOMP=^VCOMP_$D(A)_" "_$D(A(2))_" "   ;10 0 
 S ^VCOMP=^VCOMP_$D(B)_" "_$D(B(2))_" "   ;11 1 
 S ^VCOMP=^VCOMP_$D(C)_" "_$D(C(2))_" "   ;11 1 
 S ^VCOMP=^VCOMP_$D(D)_" "_$D(D(2))_" "   ;0 0 
 I $D(A)#10=1    S ^VCOMP=^VCOMP_A        ;a

V3NEW9 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"79---V3NEW9: NEW -9-"
 W !!,"NEW (name1,name2)"
 ;
17 S ^ABSN="30924",^ITEM="III-0924  $D(lvn)=0"
 S ^NEXT="18^V3NEW9,V3NEW10^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWEXC21
 ...
 D ^VEXAMINE
 ;
18 S ^ABSN="30925",^ITEM="III-0925  $D(lvn)=1"
 S ^NEXT="^V3NEW10,V3NEW11^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 S A="A",B="B",C="C"
 D NEWEXC22

V3NEWK1 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"89---V3NEWK1: NEW -19-"
 ;KILL command
 W !!,"Selective NEW and Kill command"
 ;
37 S ^ABSN="30944",^ITEM="III-0944  $D(lvn)=0"
 S ^NEXT="38^V3NEWK1,V3NEWK2^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWSEL1
 ...
 S ^VCORR="000/11 1 1 0 10 1 0 0 aa(2)bc(2)#0 0 1 0 0 0 0 0 b#0 0 1 0 0 0 0 0 b"
 D ^VEXAMINE
 ;
38 S ^ABSN="30945",^ITEM="III-0945  $D(lvn)=1"
 S ^NEXT="39^V3NEWK2,V3NEWK3^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="101/11 1 1 0 11 1 0 0 aa(2)bCc(2)#11 1 0 0 11 1 0 0 aa(2)Cc(2)#11 1 1 0 11 1 0 0 aa(2)BCc(2)"
 D ^VEXAMINE
 ;
END W !!,"End of 89 --- V3NEWK1",!
 K  Q
 ;
NEWSEL1 ;
 NEW A

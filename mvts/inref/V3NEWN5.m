V3NEWN5 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"126---V3NEWN5: NEW -56-"
 ;
136 S ^ABSN="31043",^ITEM="III-1043  all, selective, all      "
 S ^NEXT="137^V3NEWN5,V3NEWN6^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 S ^VV("D")="D"
 D NEW1,CHECK
 ...
 D ^VEXAMINE K ^VV
 ;
137 S ^ABSN="31044",^ITEM="III-1044  all, selective, selective"
 S ^NEXT="138^V3NEWN5,V3NEWN6^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 D NEW2,CHECK
 S ^VCORR="11 1 11 1 11 1 10 1 a3a(3)b3AAc(3)d(3)#1 0 11 1 11 1 0 0 ab3AAc(3)#11 1 11 1 11 1 0 0 A(""AB"")CB@A@(2.4)Ac(3)#1 0 10 0 11 0 0 0 a1c1#"
 D ^VEXAMINE
 ;
138 S ^ABSN="31045",^ITEM="III-1045  all, selective, exclusive"
 S ^NEXT="^V3NEWN6,V3NEWN7^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 D NEW3,CHECK
 S ^VCORR="1 0 0 0 10 1 0 0 a3c(3)#11 1 1 0 10 1 0 0 a2@C(""AB"",2.4)b2c(3)#11 1 11 1 11 1 0 0 a2@C(""AB"",2.4)BB(1)CC(1)#1 0 10 0 11 0 0 0 a1c1#"
 D ^VEXAMINE
 ;
END W !!,"End of 126 --- V3NEWN5",!
 K  K ^VV Q
 ;
NEW1 ;

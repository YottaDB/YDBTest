V3NEWN11 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"132---V3NEWN11: NEW -62-"
 ;
154 S ^ABSN="31061",^ITEM="III-1061  exclusive, selective, all      "
 S ^NEXT="155^V3NEWN11,V3NEWN12^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 S ^VV("D")="D"
 D NEW1,CHECK
 S ^VCORR="1 0 10 1 11 1 1 0 a3b(3)c3c(3)d3#11 1 11 1 10 1 10 1 aa(2)b@C(""AB"",2.4)c(2)d(2)#11 1 0 0 10 1 0 0 aa(2)c(2)#1 0 10 0 11 0 0 0 a1c1#"
 D ^VEXAMINE K ^VV
 ;
155 S ^ABSN="31062",^ITEM="III-1062  exclusive, selective, selective"
 S ^NEXT="156^V3NEWN11,V3NEWN12^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 D NEW2,CHECK
 S ^VCORR="11 1 11 1 11 1 10 1 a3a(3)b3AAc(3)d(3)#1 0 11 1 11 1 0 0 ab3AAc(3)#11 1 11 1 11 1 0 0 A(""AB"")CB@A@(2.4)Ac(3)#1 0 11 1 11 1 0 0 a1B@A@(2.4)Ac(3)#"
 D ^VEXAMINE
 ;
156 S ^ABSN="31063",^ITEM="III-1063  exclusive, selective, exclusive"
 S ^NEXT="^V3NEWN12,END^V3NEW,V3ALDO^VV3" D ^V3PRESET K  S ^VCOMP=""
 D NEW3,CHECK
 S ^VCORR="1 0 0 0 10 1 0 0 a3c(3)#11 1 1 0 10 1 0 0 a2@C(""AB"",2.4)b2c(3)#11 1 11 1 11 1 0 0 a2@C(""AB"",2.4)BB(1)CC(1)#11 1 10 0 11 0 0 0 a2@C(""AB"",2.4)c1#"
 D ^VEXAMINE
 ;
END W !!,"End of 132 --- V3NEWN11",!
 K  K ^VV Q
 ;
NEW1 ;

V3NEW3 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"73---V3NEW3: NEW -3-"
 W !!,"Selective NEW"
 ;
5 S ^ABSN="30912",^ITEM="III-0912  $D(lvn)=0"
 S ^NEXT="6^V3NEW3,V3NEW4^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWSEL1
 ...
 S ^VCORR="000/11 1 1 0 10 1 0 0 aa(2)bc(2)#0 0 1 0 10 1 0 0 bc(2)"
 D ^VEXAMINE
 ;
6 S ^ABSN="30913",^ITEM="III-0913  $D(lvn)=1"
 S ^NEXT="^V3NEW4,V3NEW4^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="101/11 1 1 0 11 1 0 0 aa(2)bCc(2)#11 1 1 0 11 1 0 0 aa(2)BCc(2)"
 D ^VEXAMINE
 ;
END W !!,"End of 73 --- V3NEW3",!
 K  Q
 ;
NEWSEL1 ;
 NEW A

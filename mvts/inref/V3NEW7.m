V3NEW7 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"77---V3NEW7: NEW -7-"
 W !!,"NEW name1,name2"
 ;
13 S ^ABSN="30920",^ITEM="III-0920  $D(lvn)=0"
 S ^NEXT="14^V3NEW7,V3NEW8^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWSEL21
 ...
 D ^VEXAMINE
 ;
14 S ^ABSN="30921",^ITEM="III-0921  $D(lvn)=1"
 S ^NEXT="^V3NEW8,V3NEW9^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="100/11 1 1 0 10 1 0 0 aa(2)bc(2)#11 1 1 0 1 0 0 0 aa(2)BC"
 D ^VEXAMINE
 ;
END W !!,"End of 77 --- V3NEW7",!
 K  Q
 ;
NEWSEL21 ;
 N A,B

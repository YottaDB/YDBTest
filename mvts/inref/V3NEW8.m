V3NEW8 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"78---V3NEW8: NEW -8-"
 ;
15 S ^ABSN="30922",^ITEM="III-0922  $D(lvn)=10"
 S ^NEXT="16^V3NEW8,V3NEW9^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 D ^VEXAMINE
 ;
16 S ^ABSN="30923",^ITEM="III-0923  $D(lvn)=11"
 S ^NEXT="^V3NEW9,V3NEW10^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""

V3NEW5 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"75---V3NEW5: NEW -5-"
 W !!,"Exclusive NEW"
 ;
9 S ^ABSN="30916",^ITEM="III-0916  $D(lvn)=0"
 S ^NEXT="10^V3NEW5,V3NEW6^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWEXC1
 ...
 D ^VEXAMINE
 ;
10 S ^ABSN="30917",^ITEM="III-0917  $D(lvn)=1"
 S ^NEXT="^V3NEW6,V3NEW7^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""

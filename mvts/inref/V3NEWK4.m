V3NEWK4 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"92---V3NEWK4: NEW -22-"
 ;
43 S ^ABSN="30950",^ITEM="III-0950  $D(lvn)=10"
 S ^NEXT="44^V3NEWK4,V3NEWF1^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 S ^VCORR="0010/11 1 1 0 10 1 0 0 aa(2)bc(2)#11 1 0 0 10 1 0 0 aa(2)c(2)#10 1 10 1 10 1 0 0 A(2)B(2)c(2)"
 D ^VEXAMINE
 ;
44 S ^ABSN="30951",^ITEM="III-0951  $D(lvn)=11"
 S ^NEXT="^V3NEWF1,V3NEWF2^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="000/11 1 1 0 10 1 11 1 aa(2)bc(2)dd(2)#0 0 1 0 10 1 0 0 bc(2)#11 1 11 1 11 1 0 0 AA(2)BB(2)CC(2)"
 D ^VEXAMINE
 ;
END W !!,"End of 92 --- V3NEWK4",!
 K  Q
 ;
NEWEXC3 ;
 NEW (C)

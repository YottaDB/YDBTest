V3NEW17 ;IW-KO-YS-TS,V3NEW,MVTS V9.10;15/6/96;
 ;COPYRIGHT MUMPS SYSTEMS LABORATORY 1990-1996
 W !!,"87---V3NEW17: NEW -17-"
 W !!,"NEW (name,name)  same name"
 ;
33 S ^ABSN="30940",^ITEM="III-0940  $D(lvn)=0"
 S ^NEXT="34^V3NEW17,V3NEW18^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 D NEWEXC1                                ;NEW (A,A)
 ...
 D ^VEXAMINE
 ;
34 S ^ABSN="30941",^ITEM="III-0941  $D(lvn)=1"
 S ^NEXT="^V3NEW18,V3NEW19^V3NEW,V3ALDO^VV3" D ^V3PRESET K
 S ^VCOMP=""
 ...
 I $D(D)#10=1    S ^VCOMP=^VCOMP_D        ;
 I $D(D(2))#10=1 S ^VCOMP=^VCOMP_D(2)     ;
 S ^VCORR="010/11 1 1 0 10 1 0 0 aa(2)bc(2)#1 0 1 0 1 0 0 0 AbC"
 D ^VEXAMINE
 ;
END W !!,"End of 87 --- V3NEW17",!
 K  Q
 ;
NEWEXC1 ;
 NEW (A,A)

inttp1	; ; ; Test of random transaction interference
	;
	set output="inttp1.mjo0",error="inttp1.mje0"
	...
	set ^endloop=0
	set $ztrap="set $ztrap="""" goto ERROR^inttp1"
	;
	set ITEM="TPROLLBACK Test",ERR=0,unix=$zv'["VMS"
	write ITEM,!
	;
	write "Start set/kill...",!
	do ^job("job^inttp1",6,"""""")
	quit

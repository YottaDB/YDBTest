...
# In this test, block_size= 512, reserved_bytes=6, so key size should be smaller than 512-6-16-4-4-8-8=466
EOF
$echoline
$GDE << GDE_EXIT
...
#  Change the key size to 467, change the block size to 1024, set the reserved bytes to 6, 

...
#################################################################
#
# Test of ydb_subscript_prev_st() function for Intrinsic Special variables in the SimpleThreadAPI
#
echo "Copy all C programs that need to be tested"
cp $gtm_tst/$tst/inref/isvsubsprev*.c .

foreach file (isvsubsprev*.c)
	echo " --> Running $file <---"
	set exefile = $file:r

...
$gt_ld_linker $gt_ld_option_output stack_leak $gt_ld_options_common stack_leak.o $gt_ld_sysrtns $ci_ldpath$gtm_dist -L$gtm_dist $tst_ld_yottadb $gt_ld_syslibs >& link.map
if ($status) then
	echo "Linking failed:"
	cat link.map
	exit 1

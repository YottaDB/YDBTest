...
$gt_cc_compiler $gtt_cc_shl_options $gtm_tst/$tst/inref/timers.c -I$gtm_dist -g -DDEBUG
$gt_ld_linker $gt_ld_option_output timers $gt_ld_options_common timers.o $gt_ld_sysrtns $ci_ldpath$gtm_dist -L$gtm_dist $tst_ld_yottadb $gt_ld_syslibs >& link.map
if ($status) then
	echo "Linking failed:"
	cat link.map
endif

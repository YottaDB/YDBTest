...
EOF
#
$gt_cc_compiler $gt_cc_shl_options -I$gtm_tst/com -I$gtm_dist $gtm_tst/$tst/inref/lengthc.c >& compiler.outx
if($status) then 
...
$gt_cc_compiler $gt_cc_options_common -I$gtm_dist $gtm_tst/$tst/inref/unic2m2c2m.c

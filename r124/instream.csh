...
# ydb312_gtm8182b  [jake]  Test $zpeek to ensure there is no longer a memory leak issue with jnlpool_init()
#-------------------------------------------------------------------------------------------------------------
...
setenv subtest_list_replic     "$subtest_list_replic ydb282srcsrvrerr ydb293 ydb312_gtm8182b"

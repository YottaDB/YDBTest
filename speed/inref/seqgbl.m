...
SETOP;  Sets 
	...
	.  .  SET ^afill(jobno,ndx)=$piece(cndx,"|",2)
        ...
        SET et2=$H
	do RESULT^seqgbl(^opname(1),t1,t2,et1,et2)
...
READOP; Reads
	...
	.  .  SET RES=^afill(jobno,ndx)
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(2),t1,t2,et1,et2)
	q
GETOP; $GET
	SET ^opname(3)="GETOP"
	SET et1=$H
	...
	.  .  SET RES=$GET(^afill(jobno,ndx))
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(3),t1,t2,et1,et2)
	q
DATAOP; $DATA
	SET ^opname(4)="DATAOP"
	SET et1=$H
	...
	.  .  SET RES=$DATA(^afill(jobno,ndx))
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(4),t1,t2,et1,et2)
	q
ORDEROP; $ORDER
	...
	.  .  SET RES=$ORDER(^afill(jobno,ndx))
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(5),t1,t2,et1,et2)
	q
ZPREVOP; $ORDER(x,-1)
	...
	.  .  SET RES=$ORDER(^afill(jobno,ndx),-1)
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(6),t1,t2,et1,et2)
	q
QUERYOP; $QUERY
	...
	.  .  SET RES=$QUERY(^afill(jobno,ndx))
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(7),t1,t2,et1,et2)
	q
KILLOP; KILL
	SET ^opname(8)="KILLOP"
	SET et1=$H
	...
	.  .  KILL ^afill(jobno,ndx)
        ...
        SET t2=$ZGETJPI(0,"CPUTIM")
        SET et2=$H
	do RESULT^seqgbl(^opname(8),t1,t2,et1,et2)
	q

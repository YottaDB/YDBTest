...
$gtm_dist/mumps -run %XCMD 'set x=$&ydbposix.unsetenv("SHELL",.errno) zsystem "echo THIS ALWAYS WORKS" zsystem "echo PASS"'
...
printf "printf PASS1 && exit\n" | $gtm_dist/mumps -run %XCMD 'set x=$&ydbposix.unsetenv("SHELL",.errno) write "Test1:" zsy  write !'
printf "printf PASS2 && exit\n" | $gtm_dist/mumps -run %XCMD 'set x=$&ydbposix.unsetenv("SHELL",.errno) write "Test2:" zsy "" write !'
$gtm_dist/mumps -run %XCMD 'set x=$&ydbposix.unsetenv("SHELL",.errno) write "Test3:" zsy "echo PASS3" write !'

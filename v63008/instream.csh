...
# The gtm9082 subtest requires a build < V63003 to exist.
# Check if V63002 exists. If not, it is unlikely other prior builds exist. So disable this subtest in that case.
if (! -e $gtm_root/V63002/$tst_image) then

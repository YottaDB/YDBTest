...
#								#
#################################################################
#;;;Test handling of interrupts during fifo reads
...
echo "**************************** fixednonutf ***********************"
$echoline
$gtm_dist/mumps -run fifointrdriver fixednonutf >& fixednonutf.out
...
echo "**************************** streamnonutf ****************************"
$echoline
$gtm_dist/mumps -run fifointrdriver streamnonutf >& streamnonutf.out
# make sure the read and interrupt processes are done
...
rm fifointrdriver.o sendintr.o fiforeadintr.o fifosenddata.o
$switch_chset UTF-8
$echoline
echo "**************************** streamutf8 ***********************"
$echoline
$gtm_dist/mumps -run fifointrdriver streamutf8 >& streamutf8.out
# make sure the read and interrupt processes are done
...
echo "**************************** fixedutf8 ***********************"
$echoline
$gtm_dist/mumps -run fifointrdriver fixedutf8 >& fixedutf8.out
# make sure the read and interrupt processes are done
...
echo "**************************** streamutf16 ***********************"
$echoline
$gtm_dist/mumps -run fifointrdriver streamutf16 >& streamutf16.out
# make sure the read and interrupt processes are done
...
echo "**************************** fixedutf16 ***********************"
$echoline
$gtm_dist/mumps -run fifointrdriver fixedutf16 >& fixedutf16.out
# make sure the read and interrupt processes are done

...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
diskintrdriver
	; This function is executed via mumps in diskintrpt.csh
	...
	; the specified version(like fixednonutf) of disksenddata, diskreadintr, and sendintr.  Quit when told to via ^quit.
	...
	job @($zcmdline_"^disksenddata("""_$zcmdline_"""):(output="""_$zcmdline_"write.mjo"":error="""_$zcmdline_"write.mje"""_")")
	job @($zcmdline_"^diskreadintr("""_$zcmdline_"""):(output="""_$zcmdline_"read.mjo"":error="""_$zcmdline_"read.mje"""_")")

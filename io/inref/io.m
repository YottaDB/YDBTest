io	;Tools to aid in IO devices tests,
	...
	; will zshow a device
open(device,openpararametertocontrolbehavior,timeout) ; OPEN device with the parameters supplied

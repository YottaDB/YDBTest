...
#%GTM-W-LITNONGRAPH, M standard requires graphics in string literals
...
{
	# Read 4 lines, and if the 4th line has GTM-W-LITNONGRAPH, do not print any of the above read 4 lines and restart reading
	# Maintain a queue of size 3 and if not GTM-W-LITNONGRAPH, flush the first-in to the output
	if ($1 == "%GTM-W-LITNONGRAPH,")
	{

...
#								#
#################################################################
# Create 1 or more database files and 1 global directory
# Usage:
# $1: Basename of the first database file, and of the only global directory
# $2: The total number of database files to create. Database files after the first will be named 'a.dat', 'b.dat', etc. by com/dbcreate_multi.awk.
# $3+: Additional arguments parsed by keyword or positionally according to the order in com/dbcargs.m and com/dbcreate_multi.awk.

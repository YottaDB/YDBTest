...

{
	...
	# Next Renegotiate Time can show up as 0 OR ..../../.. ..:..:.. depending on whether the first renegotiation
	# happened or not (which is timing based and can vary with test runs) and so treat both of them the same below.

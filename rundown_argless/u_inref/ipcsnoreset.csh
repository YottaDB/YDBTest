...
# behind. This test exposes this problem by launching consecutive MUPIP RUNDOWN and MUPIP ROLLBACKS.  Under normal conditions, MUPIP
# RUNDOWN shouldn't remove the shared resources if it's not their creator. If the bug persists, MUPIP ROLLBACK should realize that
# the shared resources are up in the memory while they are invalidated in the file header.

...
ctrp	;
	...
	use $P:(NOCENABLE:EXCEPTION="do good":CTRAP=$C(2,5,11):TERM=$C(1,2,5,6,11,13,18,21,27))
	do writestar
...
repeat
	new dist,editing,file,lbl,rtn,term,terminfo
	set file="replay.sourceme"
	...
	open file:append
	use file
	write !,"echo REPEAT the following",!

...
$gt_ld_linker ${gt_ld_option_output} miximage $gt_ld_options_common miximage.o $gt_ld_sysrtns $ci_ldpath$gtm_dist -L$gtm_dist $tst_ld_yottadb $gt_ld_syslibs >& link.map
if (0 != $status) then
	cat link.map
endif
#

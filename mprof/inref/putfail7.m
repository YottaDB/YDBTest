...
; This line used to cause a GVPUTFAIL, failure code HHHH
	Set ^PF("A30")="X30"_X1000_X300_X100
	...
	If ^PF("A30")'=("X30"_X1000_X300_X100) Set PASS=0 Write "^PF(""A30"") not stored properly",!
	If PASS Write "   PASS - putfail7",!
	Else  Write "** FAIL - putfail7",!  Set errcnt=errcnt+1
	Quit

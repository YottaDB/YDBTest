VVINST8	;Instruction V.7.1 -8-;TS,INSTRUCT,VALIDATION VERSION 7.1;31-AUG-1987;
...
TEX	;
	...
	;
	;
	;    **Failure in producing ERROR for III-4.1    ....Stopped by Validation                                                            and Failure is counted. 
	...
	;
	;    III-9  P.I-32  I-3.5.7   Line Reference (2) 
	...
	;automatically.  However, those tests showing the case of Example 2, can be 
	;manually filled in  this column.
	;

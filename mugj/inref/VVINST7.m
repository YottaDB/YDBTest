VVINST7	;Instruction V.7.1 -7-;TS,INSTRUCT,VALIDATION VERSION 7.1;31-AUG-1987;
...
TEX	;
	...
	;
	;2.7  Steps to be followed to execute Part-III
	;
	;1)  Get the Structure Table of Part-III from the Instruction Document. 
	;
	...
	;                  >D 4^VVENAK<cr>
	;
	;    All the routines have four labels for entry (1, 2, 3, and 4), and the 
	;direct command "DO" must always identify only these labels of the routines.
	;
	;3)  Results of the subroutines would stop in one of the following three 
	;       examples.
	;

...
$gtm_tst/com/check_error_exist.csh dse_dump.out GTM-E-DBENDIAN GTM-E-DBNOREGION
...
$gtm_tst/com/check_error_exist.csh gtm.out GTM-E-DBENDIAN

echo "# LKE show"
$LKE show -all >&! lke.out
$gtm_tst/com/check_error_exist.csh lke.out GTM-E-DBENDIAN GTM-E-DBNOREGION

echo "# MUPIP integ"
$MUPIP integ -region "*" >&! mupip_integ.out
$gtm_tst/com/check_error_exist.csh mupip_integ.out GTM-E-DBENDIAN MUNOTALLINTEG

echo "# MUPIP freeze"
$MUPIP freeze -on "*" >&! mupip_freeze.out
$gtm_tst/com/check_error_exist.csh mupip_freeze.out GTM-E-DBENDIAN

echo "# MUPIP backup"
mkdir bak_dir
$MUPIP backup -database "*" bak_dir >&! mupip_backup.out
$gtm_tst/com/check_error_exist.csh mupip_backup.out GTM-E-DBENDIAN

echo "# MUPIP extract"
$MUPIP extract extract.glo >&! mupip_extract.out
$gtm_tst/com/check_error_exist.csh mupip_extract.out GTM-E-DBENDIAN
